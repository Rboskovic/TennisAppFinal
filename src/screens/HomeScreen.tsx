...
export default function HomeScreen() {
  ...
  return (
    <div
      className="h-screen relative overflow-hidden pb-24"
    ...
    >
      ...
      <div className="relative z-10 p-6 text-white">
        ...
        <div className="flex justify-between items-start mb-2">
          <div className="flex flex-col">
            ...
            <div>
              ...
              <div
                className="text-5xl font-bold leading-tight text-white tracking-tight -mt-1"
        ...
        <div style={{ marginBottom: "20px" }}>
          <h2
            className="text-2xl tracking-tight drop-shadow-sm mb-3"
